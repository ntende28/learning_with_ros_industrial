...
if("TRUE" STREQUAL "TRUE")
  set(myworkcell_core_SOURCE_PREFIX /home/movertraining/kens_ws/src/myworkcell_core)
  set(myworkcell_core_DEVEL_PREFIX /home/movertraining/kens_ws/devel)
  ...
  set(myworkcell_core_INSTALL_PREFIX /home/movertraining/kens_ws/install)
...
if(NOT "/home/movertraining/kens_ws/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'myworkcell_core' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/movertraining/kens_ws/src/myworkcell_core/${idir}'.  ${_report}")
    endif()
...
set(depends "fake_ar_publisher;geometry_msgs;message_generation;roscpp")
foreach(depend ${depends})
  ...
  _list_append_deduplicate(myworkcell_core_EXPORTED_TARGETS ${${myworkcell_core_dep}_EXPORTED_TARGETS})
endforeach()
